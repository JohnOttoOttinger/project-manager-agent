...
// Otto: widened from the upstream five so the four agents built here
// (Business Development, Analytics, Strategy, Sourcing) can each hold a
// unique accent. Nothing renders accentColour today — it is validation only.
