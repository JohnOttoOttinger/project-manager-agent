---
routine: oddtoe-money-page-scout
trigger: trig_01VWVM4TBJVa8DgjeU5bajCz
schedule: 0 6 * * * UTC  (4pm AEST / 5pm AEDT)
---

# Oddtoe money-page scout - 4pm
...
## 1. Otto's own queue comes first
    ...
    python3 skills/money-pages/scripts/suggest.py --list oddtoe
...
## 2. The algorithmic candidates
    ...
    python3 skills/money-pages/scripts/next-content.py --brand oddtoe --json --limit 3
...
To otto@datalabsagency.com, subject exactly:
    ...
    Money page candidates - <YYYY-MM-DD>
...
idea can also go straight in with:
    ...
    python3 skills/money-pages/scripts/suggest.py oddtoe "the page he wants"
