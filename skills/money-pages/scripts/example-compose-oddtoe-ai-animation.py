...
# Oddtoe link style (Otto, 16 Aug 2026): strong-wrap + the theme's decorated-link class.
# The class is generated by Ronneby Theme Options -> Styling options -> Link options
# (tan #c39f76 base, olive #8a8f6a hover, dotted tan underline -> solid on hover, 16px).
# NEVER inline link colours -- inline styles block the theme hover.
