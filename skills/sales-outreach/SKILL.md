...
- **Track and follow up.** Not built yet. Click tracking reads GA4 for the guide-page link; the single follow-up is prepared when it comes due. Neither has a tool. Never claim to pull open rates, and never claim a draft was sent — the user sends every email personally. Mailchimp is not connected and is not part of this flow.
