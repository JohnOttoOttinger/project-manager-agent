...
5. **Visible dates.** "Updated August 2026" with real content behind the date. Refresh the date only when content actually changes.
6. **One canonical definitional sentence per brand**, reused verbatim everywhere. Never paraphrase it. The sentences live in `references/brands.md`.
